...
/**
 * The {@code NDFA_JSON_Exporter} class is responsible for exporting an NDFA structure
 ...
 */
public class NDFA_JSON_Exporter {
     ...
     */
    public void toJsonFile(NDFA_Struct ndfa, String filename) {
        try (FileWriter writer = new FileWriter(filename)) {
            ...
            Set<NDFA_Struct.Etat> visites = new HashSet<>();
    ...
    private void collectEtatForJson(NDFA_Struct.Etat etat, List<Map<String, String>> nodes, List<Map<String, String>> links,
        ...
        for (NDFA_Struct.Etat suivant : etat.transitionsEpsilon) {
            Map<String, String> link = new HashMap<>();
            link.put("source", String.valueOf(etat.id)); // Ensure source is a String
            link.put("target", String.valueOf(suivant.id)); // Ensure target is a String
