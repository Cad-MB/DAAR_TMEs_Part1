 ...
 */
public class DFA_StructTest {

    private DFA_Struct.Etat etat1;
    private DFA_Struct.Etat etat2;
    private DFA_Struct.Etat etat3;

    @BeforeEach
    public void setUp() {
        // Initialize DFA states before each test
        NDFA_Struct.Etat.compteur = 0; // Reset state counter for each test
        etat1 = new DFA_Struct.Etat();
        etat2 = new DFA_Struct.Etat();
        etat3 = new DFA_Struct.Etat();
    }
    ...
    public void testDFAToString() {
        ...
        DFA_Struct dfa = new DFA_Struct(etat1, Set.of(etat3));
    ...
    public void testEmptyDFA() {
        ...
        DFA_Struct dfa = new DFA_Struct(etat1, Set.of(etat1));
